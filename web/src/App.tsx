    ...
    <div className="max-w-[1344px] mx-auto flex flex-col items-center my-20">
      ...
      <div className="grid grid-cols-6 gap-6 mt-16">
        <a href="" className="relative rounded-lg overflow-hidden">
          ...
          <div className="w-full pt-16 pb-4 px-4 bg-game-gradient absolute bottom-0 left-0 right-0" >
            ...
            <span className="text-zinc-300 text-sm block">120 anúncios</span>
          </div>
        </a>
        ...
        <a href="" className="relative rounded-lg overflow-hidden" >
          ...
          <div className="w-full pt-16 pb-4 px-4 bg-game-gradient absolute bottom-0 left-0 right-0" >
            ...
            <span className="text-zinc-300 text-sm block">23 anúncios</span>
          </div>
        </a>
      ...
      <div className="pt-1 bg-nlw-gradient mt-8 self-stretch rounded-lg overflow-hidden">
        <div className="bg-[#2a2634] px-8 py-6 flex justify-between items-center">
          ...
          <MagnifyingGlass size={24}/> Publicar anúncio
          </button>
